...
public class FileUtils {
    ...
    public void addScreenshot(Scenario scenario, WebDriver driver) throws IOException {
        ...
        String targetPath = new File("..\\Selenium-Cucumber-Assignment\\screenshots\\" + nameScreenshot).getCanonicalPath();
        ...
        if (scenario.isFailed()) {
            try {
                ...
                scenario.attach(screenshot, "image/png", nameScreenshot); //stick it in the report
                try {
