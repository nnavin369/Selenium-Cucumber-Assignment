...
*/
	 ...
	 public boolean JSChecked(WebDriver driver, WebElement ele) {
			boolean flag = false;
			try {
				JavascriptExecutor executor = (JavascriptExecutor) driver;
				executor.executeScript("arguments[0].checked=true;", ele);
				flag = true;
	...
	public boolean JSFocus(WebDriver driver, WebElement ele) {
		boolean flag = false;
		try {
			...
			if (flag) {
				System.out.println("Focus Action is performed");
			} else if (!flag) {
				System.out.println("Focus Action is not performed");
			}
		}
		return flag;
	}
